		...
		<fieldset>
			...
			<div class="form-group has-feedback">
				...
				<div class="col-md-6">
					...
					<p class="help-block"><?php echo lang("register_form_loginHelp");?></p>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="userNotificationInput"><?php echo lang("register_form_notificationInput"); ?></label>
				<div class="col-md-8">
					<input id="userNotificationInput" name="userNotificationInput"
						value="dm" type="hidden">
					<div id="userNotificationButtons" class="btn-group" role="group" aria-label="...">
						<button value="none" type="button" class="btn btn-default <?php if ($notification == "none") { echo "active"; } ?>"><span class=""><?php echo lang("register_form_notification_none"); ?></span></button>
						<button value="mail" type="button" class="btn btn-default <?php if ($notification == "mail") { echo "active"; } ?>"><span class=""><?php echo lang("register_form_notification_mail"); ?></span></button>
						<button value="simpledm" type="button" class="btn btn-default <?php if ($notification == "simpledm") { echo "active"; } ?>"><span class=""><?php echo lang("register_form_notification_simpledm"); ?></span></button>
						<button value="dm" type="button" class="btn btn-default <?php if ($notification == "dm") { echo "active"; } ?>"><span class=""><?php echo lang("register_form_notification_dm"); ?></span></button>
					</div>
				</div>
			</div>
